...
- `components/Icon/definition/` is a leaf with its own index for icon contracts and normalization. It may import only local definitions and React types. Config and sprite consumers use this index; the component index re-exports public contracts but keeps normalization internal.
