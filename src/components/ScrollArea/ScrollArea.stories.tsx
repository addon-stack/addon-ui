    ...
    args: {
        ...
        children:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vehicula, " +
                "justo at congue malesuada, arcu elit malesuada eros, ut tempor justo libero " +
                "a est. Donec sit amet tortor nec justo auctor sagittis. Suspendisse potenti. " +
                "Fusce gravida, libero vel auctor pretium, odio risus vehicula nunc, et " +
                "ultricies nunc arcu a neque. Aliquam erat volutpat. Morbi vulputate erat nec " +
                "lectus vestibulum, at ullamcorper risus aliquet",
    },
};
